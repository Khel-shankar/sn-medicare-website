...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[url('/images/kivo-pro-hero.png')] bg-cover bg-center opacity-20" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <Image
              ...
              width={500}
              height={700}
              className="rounded-2xl border border-border shadow-2xl mx-auto"
            />
          </motion.div>
        </div>
      </div>
