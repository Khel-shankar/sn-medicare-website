...
export const products: Product[] = [
  {
    ...
    size: "5cm × 5m Roll",
    images: [
      "/images/kivo-pro-hero.webp",
      "/images/kivo-pro-flyer.webp",
      "/images/kivo-pro-product.webp",
      "/images/kivo-pro-hero-prev.webp",
      "/images/kivo-pro-flyer-prev.webp",
      "/images/kivo-pro-specs.webp",
    ],
  ...
  },
  {
    ...
    size: "5cm × 5m Roll",
    images: [
      "/images/kivo-plus-flyer.webp",
      "/images/kivo-plus-product.webp",
      "/images/kivo-plus-hero.webp",
      "/images/kivo-plus-lifestyle.webp",
    ],
    videos: [
      "/videos/kivo-plus-demo.mp4",
      "/videos/kivo-plus-reel.mp4",
    ],
    accentColor: "#00d4aa",
    badge: "Value Pick",
    features: [
